...
my $encoding = 'utf-8';
my $data_directory = "C:\\Users\\meagu\\OneDrive\\Documents\\Proyecto_Limpieza_Datos\\Datos\\";
...
print scalar(@txt_file_names_arr);
foreach my $txt_file_name (@txt_file_names_arr) {
 ...
 # $txt_file_name="Corso di lingua Giapponese per Italiani - Lezioni 1-15.txt";
  ...
  while ($line = $line_iterator->()){
    chomp $line;
    $count = () =  ($line =~ /((?:[▸βα\!▲↔→⇒⇔…<－―～〜~／'"\*\(\[\{〈《「『【〔〖｟〘（［｛｢\-＃←⇨\x{2460}-\x{2472}＆ꜜ→°※γ•・ー\x{30}-\x{39}\x{FF10}-\x{FF19}\x{2160}-\x{2164}\x{2460}-\x{2472}\x{2070}\x{2074}\x{2078}\x{2081}-\x{2084}\x{2088}\x{2776}-\x{2781}＠=＝\/]*[\p{InHanLeter}\p{InHiraganaLeter}\p{InKatakanaLeter}][\x{FF21}-\x{FF3A}\x{FF41}-\x{FF5A}π×\)\]\}\-〉》」』】〕〗〙）］｝◯｣。，＋、〜、.…,、；;\!！?？：:％＿／…“”＼\/－～~＜>·｜｠‐_―＆ꜜ→°※γ•・ー\x{30}-\x{39}\x{FF10}-\x{FF19}\x{2160}-\x{2164}\x{2460}-\x{2472}\x{2070}\x{2074}\x{2078}\x{2081}-\x{2084}\x{2088}\x{2776}-\x{2781}＠=＝]*)+\s*(?R)?)/gmu);
...
if ($filtered_str =~ /^(?:\\s|\s*[\x{FF21}-\x{FF3A}\x{FF41}-\x{FF5A}π×▸βα\!▸◆➡▲↔→⇒⇔…<－―～〜~／'"\*\(\[\{〈《「『【〔〖｟〘（［｛｢\-＃←⇨\x{2460}-\x{2472}＆ꜜ→°※γ•ー\x{30}-\x{39}\x{FF10}-\x{FF19}\x{2160}-\x{2164}\x{2460}-\x{2472}\x{2070}\x{2074}\x{2078}\x{2081}-\x{2084}\x{2088}\x{2776}-\x{2781}＠=＝・\)\]\}\-〉》」』】〕〗〙）］｝◯｣。，＋、〜、.…,、；;\!！?？：:％＿／…“”＼\/－～~＜>·｜｠‐_―])+\s*$/){ 
        # print 'Eliminado',"\n";
            next; 
         }
  ...
  my $data_directory_out="C:\\Users\\meagu\\OneDrive\\Documents\\Proyecto_Limpieza_Datos\\RES3\\";
...
sub get_directory_or_file_arr{
  ...
  while (my $directory_or_file_name =  decode("utf8",readdir(DIR))) {
   $directory_or_file_name = Encode::_utf8_on( $directory_or_file_name );
